    ...
    <section id="section-hero" aria-label="section" class="full-height vertical-center" data-bgimage="url(images/background/7.jpg) bottom">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('assets-front') }}/images/misc/car-2.png" class="img-fluid" alt="">
                </div>
...
@section('content')
                            ...
                            <div class="d-info">
                                <div class="d-text">
                                    ...
                                    <div class="d-atr-group">
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/1-green.svg" alt="">5</span>
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/2-green.svg" alt="">2</span>
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/3-green.svg" alt="">4</span>
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/4-green.svg" alt="">SUV</span>
                                    </div>
                                    <div class="d-price">
                            ...
                            <div class="d-info">
                                <div class="d-text">
                                    ...
                                    <div class="d-atr-group">
                                        ...
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/2-green.svg" alt="">2</span>
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/3-green.svg" alt="">4</span>
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/4-green.svg" alt="">Sedan</span>
                                    </div>
                                    <div class="d-price">
                            ...
                            <div class="d-info">
                                <div class="d-text">
                                    ...
                                    <div class="d-atr-group">
                                        ...
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/2-green.svg" alt="">2</span>
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/3-green.svg" alt="">4</span>
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/4-green.svg" alt="">Exotic Car</span>
                                    </div>
                                    <div class="d-price">
                            ...
                            <div class="d-info">
                                <div class="d-text">
                                    ...
                                    <div class="d-atr-group">
                                        ...
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/2-green.svg" alt="">2</span>
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/3-green.svg" alt="">4</span>
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/4-green.svg" alt="">Truck</span>
                                    </div>
                                    <div class="d-price">
                            ...
                            <div class="d-info">
                                <div class="d-text">
                                    ...
                                    <div class="d-atr-group">
                                        ...
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/2-green.svg" alt="">2</span>
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/3-green.svg" alt="">4</span>
                                        <span class="d-atr"><img src="{{ asset('assets-front') }}/images/icons/4-green.svg" alt="">Hatchback</span>
                                    </div>
                                    <div class="d-price">
    ...
    {{-- End Section Show Vehicule --}}

    {{-- Start Section Quality Client --}}
    ...
    {{-- End Section Quality Client --}}

    {{-- Start Section Explore The World --}}
    <section>
        <div class="container">
            <div class="row">
            <div class="col-lg-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="de-image-text">
                        ...
                        <img src="{{ asset('assets-front') }}/images/testimonial/1.jpg" class="img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="de-image-text">
                        ...
                        <img src="{{ asset('assets-front') }}/images/testimonial/2.jpg" class="img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="de-image-text">
                        ...
                        <img src="{{ asset('assets-front') }}/images/testimonial/3.jpg" class="img-fluid" alt="">
                    </div>
                </div>
                            ...
                            <div class="bloglist s2 item">
                                    <div class="post-content">
                                        <div class="post-image">
                                            ...
                                            <img alt="" src="{{ asset('assets-front') }}/images/news/pic-blog-1.jpg" class="lazy">
                                        </div>
                                        <div class="post-text">
                            ...
                            <div class="bloglist s2 item">
                                    <div class="post-content">
                                        <div class="post-image">
                                            ...
                                            <img alt="" src="{{ asset('assets-front') }}/images/news/pic-blog-2.jpg" class="lazy">
                                        </div>
                                        <div class="post-text">
                ...
                <div class="bloglist s2 item">
                        <div class="post-content">
                            <div class="post-image">
                                ...
                                <img alt="" src="{{ asset('assets-front') }}/images/news/pic-blog-3.jpg" class="lazy">
                            </div>
                            <div class="post-text">
