...
@section('hero')
    {{-- Start Section Hero --}}
    <x-hero-section title="About Us"></x-hero-section>
    {{-- End Section Hero --}}
@endsection()

@section('content')
    <!-- Start Section Description About Us And Counter -->
    <section>
        <div class="container">
            <div class="row g-5">
    ...
    <!-- End Section Description About Us And Counter -->

    <!-- Start Section Team -->
    <section aria-label="section" class="jarallax text-light">
        <img src="{{ asset('assets-front') }}/images/background/8.jpg" class="jarallax-img" alt="">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb30">
                    <div class="f-profile text-center">
                        <div class="fp-wrap f-invert">
                            ...
                            <img src="{{ asset('assets-front') }}/images/team/1.jpg" class="fp-image img-fluid" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb30">
                    <div class="f-profile text-center">
                        <div class="fp-wrap f-invert">
                            ...
                            <div class="fpw-overlay-btm"></div>
                            <img src="{{ asset('assets-front') }}/images/team/2.jpg" class="fp-image img-fluid" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb30">
                    <div class="f-profile text-center">
                        <div class="fp-wrap f-invert">
                            ...
                            <div class="fpw-overlay-btm"></div>
                            <img src="{{ asset('assets-front') }}/images/team/3.jpg" class="fp-image img-fluid" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb30">
                    <div class="f-profile text-center">
                        <div class="fp-wrap f-invert">
                            ...
                            <div class="fpw-overlay-btm"></div>
                            <img src="{{ asset('assets-front') }}/images/team/4.jpg" class="fp-image img-fluid" alt="">
                        </div>
    ...
    <!-- Start Section Features Hilight -->
    <section aria-label="section">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('assets-front') }}/images/misc/car.png" alt="" class="img-fluid wow fadeInUp">
                </div>
    ...
    <!-- Start Section Call Information -->
